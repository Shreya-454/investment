...
const Trading = () => {
    const infocard = info.map((data,i)=>(
        <div key={i} className="w-full p-2.5 bg-[#1811344D] border-2 border-solid border-[#AB68FF4D] hover:shadow-[0px_0px_20px_0px_#AB68FF] duration-300 rounded-lg sm:rounded-full backdrop-blur-lg mb-6">
