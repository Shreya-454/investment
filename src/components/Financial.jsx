...
const Financial = () => {
    const datacard1 = data1.map((card,i) =>(
        ...
        <div className={`w-full max-lg:max-w-[558px] rounded-3xl bg-[#110B26] border-2 border-solid z-[1] after:z-[2] h-[450px] md:h-[230px] border-[#AB68FF4D] p-[29px_20px_29.44px_0px] after:w-[12px] overflow-hidden border-l-[#AB68FF]  after:bg-[#AB68FF] after:absolute relative after:left-[-2px] after:top-0 after:bottom-0 ${card.class}`}>
            <div className="flex justify-between items-center">
                ...
                <div className=' justify-center w-1/3'><img src={card.img} alt="img" className={`${card.imgclass} max-md:absolute bottom-[2%] right-[30%]`} /></div>
            </div>
            <img src={card.bgimg} alt="bg" className='absolute right-0 md:top-0 bottom-0  z-[-1]' width={344} height={230} />
        </div>
                    </div>
    ))
  return (
